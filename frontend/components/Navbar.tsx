  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        <div className={`font-script text-2xl md:text-3xl transition-colors duration-300 ${isScrolled ? 'text-brand-dark-pink' : 'text-white drop-shadow-md'
          }`}>
          Doce Mania
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className={`hidden md:flex gap-6 font-medium ${isScrolled ? 'text-gray-700' : 'text-white drop-shadow-sm'}`}>
            ...
            <a href="#about" className="hover:text-brand-dark-pink transition-colors">Sobre</a>
          </div>

          <button
            onClick={openGeneralWhatsApp}
            className={`px-5 py-2 rounded-full font-semibold transition-all shadow-md ${isScrolled
